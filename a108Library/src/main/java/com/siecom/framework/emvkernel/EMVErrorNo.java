...
public class EMVErrorNo {
	...
	public static final int ERR_TRANSEXCEEDED = (-28); // 非接交易超限
	public static final int ERR_QPBOCFDDAFAIL = (-30); // 非接qPBOC fDDA失败
	public static final int ERR_APPSELRETRY = (-31); // 选择应用重试
	public static final int ERR_CVMPROC = (-32); // 执行CVM阶段
